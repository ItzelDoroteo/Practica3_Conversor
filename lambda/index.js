...
const languageStrings = {
    'en': {
        translation: {
            WELCOME_MSG: 'Welcome, you can ask me to convert units. How can I help you?',
            HELP_MSG: 'You can ask me to convert units. How can I help you?',
            GOODBYE_MSG: 'Goodbye!',
            ERROR_MSG: 'Sorry, I had trouble doing what you asked. Please try again.',
            CONVERT_MSG: '{{amount}} {{unitFrom}} corresponds to {{convertedAmount}} {{unitTo}}.',
            CONVERT_ERROR_MSG: 'Sorry, I cannot convert {{amount}} {{unitFrom}} to {{unitTo}}.'
        }
    },
    'es': {
        translation: {
            WELCOME_MSG: 'Bienvenido, puedes pedirme convertir unidades. ¿En qué puedo ayudarte?',
            ...
            CONVERT_MSG: '{{amount}} {{unitFrom}} corresponde a {{convertedAmount}} {{unitTo}}.',
